...
description: Review one live planning step for requirement, spec, contract, and TDD alignment using @.opencode/skills/baicai-vc/tdd-review-implementation.
...
Follow @.opencode/rules/baicai-vibe/agent-output.md.
...
- use @.opencode/skills/baicai-vc/tdd-review-implementation as the specialist review capability
...
Persist the result to @.planning/phase/<step-folder>/requirements-review.md using @.opencode/rules/baicai-vc/review-artifact.md, including the reviewed requirement version and step version in front matter.
