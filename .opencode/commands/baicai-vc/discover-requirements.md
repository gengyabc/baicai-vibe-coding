...
Run @.opencode/workflows/baicai-vc/discover-requirements.md
...
- use @.opencode/rules/baicai-vc/discover-requirements-output.md as the local requirement artifact contract
