...
- call @.opencode/workflows/baicai-vc/plan-step/initial.md
- stop routing
...
4. Route to `@.opencode/workflows/baicai-vc/plan-step/replan-from.md` when the step key is not yet in `implementedStepKeys` or the copied `requirement-version` in `step.md` is stale
5. Otherwise route to `@.opencode/workflows/baicai-vc/plan-step/continue-after.md`
