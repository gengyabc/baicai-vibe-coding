...
- @.opencode/workflows/baicai-vc/decide-step-specs.md
- @.opencode/rules/baicai-vc/decision-artifact.md
...
If live or archived planning memory is consulted, use @.opencode/workflows/baicai-vc/phase-log-memory/read-context.md semantics and ignore it for spec decisions unless the user explicitly asks for a handoff-oriented rewrite. Specs must stay grounded in the reviewed step, not in execution-memory notes.
...
Use the exact schema in @.opencode/rules/baicai-vc/decision-artifact.md.
