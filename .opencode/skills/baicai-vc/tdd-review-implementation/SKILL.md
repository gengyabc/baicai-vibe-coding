...
8. @.opencode/workflows/baicai-vc/phase-log-memory/read-context.md and @.opencode/workflows/baicai-vc/phase-log-memory/review-note.md when planning-memory context is needed
9. @.opencode/workflows/baicai-vc/review-requirements.md as the review workflow contract
...
Return the review as the exact durable artifact defined by @.opencode/rules/baicai-vc/review-artifact.md.


- return review content that the workflow can save to @.planning/phase/<step-number>-<step-topic>/requirements-review.md
- follow @.opencode/rules/baicai-vc/review-artifact.md exactly so later `/review-quality` work can parse the same durable structure every time
