...
- @.opencode/workflows/baicai-vc/write-step-e2e.md
...
Derive the path using @.opencode/rules/baicai-vc/naming-layout.md.
...
Do not treat planning memory as a behavior or path authority. Use @.opencode/workflows/baicai-vc/phase-log-memory/read-context.md for read semantics. `requirement.md`, `step.md`, optional `decision.md`, optional `feature.feature`, and `branch-phase.toml` stay authoritative.
