...
Use this skill as a wrapper around @.opencode/_vendor/baicai-vibe/skills/code-review-expert/SKILL.md when the user wants repeated review/fix/review loops and a machine-readable artifact that survives multiple rounds.

## Base reviewer

- Load @.opencode/_vendor/baicai-vibe/skills/code-review-expert/SKILL.md first.
...
Follow @.opencode/skills/quality-review/references/review-result-schema.md.
