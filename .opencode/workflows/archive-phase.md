...
1. If @.planning/phase/branch-phase.toml is already in `archive-sync-pending` state:
   ...
   - rerun @.opencode/workflows/phase-log-memory/topic-sync.md using the stored destination
...
5. run @.opencode/workflows/phase-log-memory/archive-preflight.md
...
13. run @.opencode/workflows/phase-log-memory/topic-sync.md
...
Follow all rules in @.opencode/rules/archive-safety.md.
