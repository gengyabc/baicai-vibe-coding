...
2. consult @.opencode/workflows/baicai-vc/phase-log-memory/read-context.md only when continuity context is useful
3. apply @.opencode/skills/baicai-vc/step-spec-gate
