...
10. follow @.opencode/rules/baicai-vc/review-flow.md for the requirements-review retry loop and exit behavior
...
Follow the source-priority rules in @.opencode/rules/baicai-vc/planning-memory.md.
