...
2. determine if E2E should be written using @.opencode/rules/baicai-vc/test-layer-mode.md
3. if E2E is not needed, exit early with "no feature.feature present"
4. consult @.opencode/workflows/baicai-vc/phase-log-memory/read-context.md only when continuity context is useful
5. resolve the canonical E2E path from @.opencode/rules/baicai-vc/naming-layout.md
6. invoke @.opencode/skills/baicai-vc/write-step-e2e/SKILL.md to create or refresh the Playwright spec
