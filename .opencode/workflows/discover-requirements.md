...
- call @.opencode/_vendor/baicai-vibe/workflows/discover-requirements-core.md first
...
- write `requirement.md` using @.opencode/rules/discover-requirements-output.md
...
- write each file exactly per @.opencode/rules/discover-requirements-output.md
