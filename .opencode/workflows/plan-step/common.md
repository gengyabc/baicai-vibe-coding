...
- If `branch-phase.toml` has `status = "archive-sync-pending"`, stop and route to @.opencode/workflows/archive-phase.md first
...
- Consult @.opencode/workflows/phase-log-memory/read-context.md only when prior planning context is useful
