...
- `@.opencode/commands/plan-step.md` is responsible for argument validation, step resolution, and mode selection
...
- shared planning rules live in @.opencode/workflows/plan-step/common.md
